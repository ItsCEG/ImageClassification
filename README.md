...
Download the DeepDetect-2025 dataset from Kaggle:

kaggle datasets download -d ayushmandatta1/deepdetect-2025

Extract the dataset and adjust the dataset path inside the notebook or training script.

4. Run the notebook

You can run the experiments using Jupyter Notebook:
